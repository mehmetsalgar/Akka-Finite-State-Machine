...
@Slf4j
public class CreditSM_AcceptableScoreCommandHandler implements CommandHandler<CreditSMCommand, CreditSM.Response> {
    ...
    public Future<CreditSM.Response> handleCommand(CreditSMCommand creditSMCommand) {
        return creditSMFacade.askAcceptableScore(convertProtobuf2Pojo(creditSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditSMCommandConstants.ON_ACCEPTABLESCORE ;
    }
