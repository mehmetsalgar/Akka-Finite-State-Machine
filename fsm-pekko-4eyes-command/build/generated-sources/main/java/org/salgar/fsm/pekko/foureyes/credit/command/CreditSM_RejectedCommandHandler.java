...
@Slf4j
public class CreditSM_RejectedCommandHandler implements CommandHandler<CreditSMCommand, CreditSM.Response> {
    ...
    public Future<CreditSM.Response> handleCommand(CreditSMCommand creditSMCommand) {
        return creditSMFacade.askRejected(convertProtobuf2Pojo(creditSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditSMCommandConstants.ON_REJECTED ;
    }
