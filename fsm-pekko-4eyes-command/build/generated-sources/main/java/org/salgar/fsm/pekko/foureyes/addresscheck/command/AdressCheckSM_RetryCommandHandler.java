...
@Slf4j
public class AdressCheckSM_RetryCommandHandler implements CommandHandler<AdressCheckSMCommand, AdressCheckSM.Response> {
    ...
    public Future<AdressCheckSM.Response> handleCommand(AdressCheckSMCommand adressCheckSMCommand) {
        return adressCheckSMFacade.askRetry(() -> adressCheckSMCommand.getUseCaseKey(), convertProtobuf2Pojo(adressCheckSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return AdressCheckSMCommandConstants.ON_RETRY ;
    }
