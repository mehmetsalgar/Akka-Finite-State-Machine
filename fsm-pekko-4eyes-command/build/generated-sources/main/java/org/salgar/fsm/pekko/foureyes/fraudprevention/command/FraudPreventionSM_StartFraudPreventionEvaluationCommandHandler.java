...
@Slf4j
public class FraudPreventionSM_StartFraudPreventionEvaluationCommandHandler implements CommandHandler<FraudPreventionSMCommand, FraudPreventionSM.Response> {
    ...
    public Future<FraudPreventionSM.Response> handleCommand(FraudPreventionSMCommand fraudPreventionSMCommand) {
        return fraudPreventionSMFacade.askStartFraudPreventionEvaluation(() -> fraudPreventionSMCommand.getUseCaseKey(), convertProtobuf2Pojo(fraudPreventionSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return FraudPreventionSMCommandConstants.ON_STARTFRAUDPREVENTIONEVALUATION ;
    }
