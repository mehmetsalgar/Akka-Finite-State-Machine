...
@Slf4j
public class CreditSM_RelationshipManagerApprovedCommandHandler implements CommandHandler<CreditSMCommand, CreditSM.Response> {
    ...
    public Future<CreditSM.Response> handleCommand(CreditSMCommand creditSMCommand) {
        return creditSMFacade.askRelationshipManagerApproved(convertProtobuf2Pojo(creditSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditSMCommandConstants.ON_RELATIONSHIPMANAGERAPPROVED ;
    }
