...
@Slf4j
public class CreditScoreSM_RetryCommandHandler implements CommandHandler<CreditScoreSMCommand, CreditScoreSM.Response> {
    ...
    public Future<CreditScoreSM.Response> handleCommand(CreditScoreSMCommand creditScoreSMCommand) {
        return creditScoreSMFacade.askRetry(() -> creditScoreSMCommand.getUseCaseKey(), convertProtobuf2Pojo(creditScoreSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditScoreSMCommandConstants.ON_RETRY ;
    }
