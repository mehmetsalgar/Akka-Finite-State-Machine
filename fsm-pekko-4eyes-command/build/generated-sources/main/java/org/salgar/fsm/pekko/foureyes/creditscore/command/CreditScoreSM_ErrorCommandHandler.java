...
@Slf4j
public class CreditScoreSM_ErrorCommandHandler implements CommandHandler<CreditScoreSMCommand, CreditScoreSM.Response> {
    ...
    public Future<CreditScoreSM.Response> handleCommand(CreditScoreSMCommand creditScoreSMCommand) {
        return creditScoreSMFacade.askError(() -> creditScoreSMCommand.getUseCaseKey(), convertProtobuf2Pojo(creditScoreSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditScoreSMCommandConstants.ON_ERROR ;
    }
