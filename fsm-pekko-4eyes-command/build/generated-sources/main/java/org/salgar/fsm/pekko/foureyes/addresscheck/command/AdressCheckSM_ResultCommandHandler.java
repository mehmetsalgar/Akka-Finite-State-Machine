...
@Slf4j
public class AdressCheckSM_ResultCommandHandler implements CommandHandler<AdressCheckSMCommand, AdressCheckSM.Response> {
    ...
    public Future<AdressCheckSM.Response> handleCommand(AdressCheckSMCommand adressCheckSMCommand) {
        return adressCheckSMFacade.askResult(() -> adressCheckSMCommand.getUseCaseKey(), convertProtobuf2Pojo(adressCheckSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return AdressCheckSMCommandConstants.ON_RESULT ;
    }
