...
@Slf4j
public class CreditSM_ResultReceivedCommandHandler implements CommandHandler<CreditSMCommand, CreditSM.Response> {
    ...
    public Future<CreditSM.Response> handleCommand(CreditSMCommand creditSMCommand) {
        return creditSMFacade.askResultReceived(convertProtobuf2Pojo(creditSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditSMCommandConstants.ON_RESULTRECEIVED ;
    }
