...
@Slf4j
public class CreditScoreSM_ResultReceivedCommandHandler implements CommandHandler<CreditScoreSMCommand, CreditScoreSM.Response> {
    ...
    public Future<CreditScoreSM.Response> handleCommand(CreditScoreSMCommand creditScoreSMCommand) {
        return creditScoreSMFacade.askResultReceived(() -> creditScoreSMCommand.getUseCaseKey(), convertProtobuf2Pojo(creditScoreSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditScoreSMCommandConstants.ON_RESULTRECEIVED ;
    }
