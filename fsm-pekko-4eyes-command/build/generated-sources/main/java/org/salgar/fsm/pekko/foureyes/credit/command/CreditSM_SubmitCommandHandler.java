...
@Slf4j
public class CreditSM_SubmitCommandHandler implements CommandHandler<CreditSMCommand, CreditSM.Response> {
    ...
    public Future<CreditSM.Response> handleCommand(CreditSMCommand creditSMCommand) {
        return creditSMFacade.askSubmit(convertProtobuf2Pojo(creditSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return CreditSMCommandConstants.ON_SUBMIT ;
    }
