...
@Slf4j
public class MultiTenantCreditScoreSM_StartMultiTenantCreditScoreResearchCommandHandler implements CommandHandler<MultiTenantCreditScoreSMCommand, MultiTenantCreditScoreSM.Response> {
    ...
    public Future<MultiTenantCreditScoreSM.Response> handleCommand(MultiTenantCreditScoreSMCommand multiTenantCreditScoreSMCommand) {
        return multiTenantCreditScoreSMFacade.askStartMultiTenantCreditScoreResearch(() -> multiTenantCreditScoreSMCommand.getUseCaseKey(), convertProtobuf2Pojo(multiTenantCreditScoreSMCommand.getPayloadMap()));
    }

    @Override
    public String type() {
        return MultiTenantCreditScoreSMCommandConstants.ON_STARTMULTITENANTCREDITSCORERESEARCH ;
    }
