...
public class CREDIT_APPLICATION_SUBMITTED_$$_CREDIT_REJECTED_isScoreTooLowGuard_GuardImpl
    ...
    public boolean evaluate(
        ...
        actorContext.log().debug("Evaluating CREDIT_APPLICATION_SUBMITTED approving_onCreditScoreReceived Guard");
    ...
    private boolean checkCondition(
        ...
        if(CreditScoreGaurdUtilities.checkCreditScore(creditTenantScoreResultMap, 0.00, 50.00)
