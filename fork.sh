...
sed "s|4eyes|$1|g" "fsm-akka-4eyes-statemachine/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-statemachine/src/main/mwe2/GenerateWorkflow.mwe2"
...
sed "s|4eyes|$1|g" "fsm-akka-4eyes-model/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-model/src/main/mwe2/GenerateWorkflow.mwe2"
#fsm-akka-***-protobuf
mkdir "fsm-akka-$1-protobuf"
mkdir -p "fsm-akka-$1-protobuf/src/main/mwe2"
sed "s|4eyes|$1|g" "fsm-akka-4eyes-protobuf/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-protobuf/src/main/mwe2/GenerateWorkflow.mwe2"
#fsm-akka-***-converter
mkdir "fsm-akka-$1-converter"
mkdir -p "fsm-akka-$1-converter/src/main/mwe2"
sed "s|4eyes|$1|g" "fsm-akka-4eyes-converter/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-converter/src/main/mwe2/GenerateWorkflow.mwe2"
#fsm-akka-****-command
mkdir "fsm-akka-$1-command"
mkdir -p "fsm-akka-$1-command/src/main/mwe2"
sed "s|4eyes|$1|g" "fsm-akka-4eyes-command/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-command/src/main/mwe2/GenerateWorkflow.mwe2"
#fsm-akka-***-kafka
mkdir "fsm-akka-$1-kafka"
mkdir -p "fsm-akka-$1-kafka/src/main/mwe2"
sed "s|4eyes|$1|g" "fsm-akka-4eyes-kafka/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-kafka/src/main/mwe2/GenerateWorkflow.mwe2"
...
sed "s|4eyes|$1|g" "fsm-akka-4eyes-elasticsearch-statemachine-adapter/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-elasticsearch-statemachine-adapter/src/main/mwe2/GenerateWorkflow.mwe2"
...
sed "s|4eyes|$1|g" "fsm-akka-4eyes-projections-statemachine-adapter/src/main/mwe2/GenerateWorkflow.mwe2" > "fsm-akka-$1-projections-statemachine-adapter/src/main/mwe2/GenerateWorkflow.mwe2"
