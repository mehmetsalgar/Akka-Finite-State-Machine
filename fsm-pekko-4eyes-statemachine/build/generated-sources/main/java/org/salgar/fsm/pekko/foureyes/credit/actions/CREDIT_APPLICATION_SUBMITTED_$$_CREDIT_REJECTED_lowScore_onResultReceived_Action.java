...
public abstract class CREDIT_APPLICATION_SUBMITTED_$$_CREDIT_REJECTED_lowScore_onResultReceived_Action
    ...
    public ReplyEffect<CreditSM.PersistEvent, CreditSM.State> doAction(
        ...
        actorContext.log().debug("Executing CREDIT_APPLICATION_SUBMITTED lowScore_onResultReceived Action");
    ...
    protected ReplyEffect<CreditSM.PersistEvent, CreditSM.State> processPersist(
        ...
        EffectBuilder<CreditSM.PersistEvent, CreditSM.State> effectBuilder =
                        Effect
                        .persist(new CreditSM.CreditScoreToLowPersistEvent(controlObject));
