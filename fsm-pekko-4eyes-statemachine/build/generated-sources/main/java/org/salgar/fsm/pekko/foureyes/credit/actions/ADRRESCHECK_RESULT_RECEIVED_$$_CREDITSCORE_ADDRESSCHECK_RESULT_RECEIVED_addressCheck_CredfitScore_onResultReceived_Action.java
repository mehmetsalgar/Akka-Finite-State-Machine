...
public abstract class ADRRESCHECK_RESULT_RECEIVED_$$_CREDITSCORE_ADDRESSCHECK_RESULT_RECEIVED_addressCheck_CredfitScore_onResultReceived_Action
    ...
    public ReplyEffect<CreditSM.PersistEvent, CreditSM.State> doAction(
        ...
        actorContext.log().debug("Executing ADRRESCHECK_RESULT_RECEIVED addressCheck_CredfitScore_onResultReceived Action");
    ...
    protected ReplyEffect<CreditSM.PersistEvent, CreditSM.State> processPersist(
        ...
        EffectBuilder<CreditSM.PersistEvent, CreditSM.State> effectBuilder =
                        Effect
                        .persist(new CreditSM.AddressCheckCreditScoreResultReceivedPersistEvent(controlObject));
