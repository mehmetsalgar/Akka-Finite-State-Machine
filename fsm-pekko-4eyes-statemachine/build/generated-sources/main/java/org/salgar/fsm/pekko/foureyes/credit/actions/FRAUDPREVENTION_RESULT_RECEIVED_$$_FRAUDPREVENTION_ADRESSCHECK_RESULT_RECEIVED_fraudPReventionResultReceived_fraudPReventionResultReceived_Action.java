...
public abstract class FRAUDPREVENTION_RESULT_RECEIVED_$$_FRAUDPREVENTION_ADRESSCHECK_RESULT_RECEIVED_fraudPReventionResultReceived_fraudPReventionResultReceived_Action
    ...
    public ReplyEffect<CreditSM.PersistEvent, CreditSM.State> doAction(
        ...
        actorContext.log().debug("Executing FRAUDPREVENTION_RESULT_RECEIVED fraudPReventionResultReceived_fraudPReventionResultReceived Action");
    ...
    protected ReplyEffect<CreditSM.PersistEvent, CreditSM.State> processPersist(
        ...
        EffectBuilder<CreditSM.PersistEvent, CreditSM.State> effectBuilder =
                        Effect
                        .persist(new CreditSM.FraudPreventionAdressCheckReceivedPersistEvent(controlObject));
