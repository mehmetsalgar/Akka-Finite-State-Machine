...
public abstract class WAITING_MULTI_TENANT_RESULTS_$$_WAITING_MULTI_TENANT_RESULTS_waitingMultiTenantResults_waitingMultiTenantResults_Action
    ...
    public ReplyEffect<MultiTenantCreditScoreSM.PersistEvent, MultiTenantCreditScoreSM.State> doAction(
        ...
        actorContext.log().debug("Executing WAITING_MULTI_TENANT_RESULTS waitingMultiTenantResults_waitingMultiTenantResults Action");
    ...
    protected ReplyEffect<MultiTenantCreditScoreSM.PersistEvent, MultiTenantCreditScoreSM.State> processPersist(
        ...
        EffectBuilder<MultiTenantCreditScoreSM.PersistEvent, MultiTenantCreditScoreSM.State> effectBuilder =
                        Effect
                        .persist(new MultiTenantCreditScoreSM.OneTenantCreditScoreResultReceived(controlObject));
        ...
        if(replyTo == null) {
            ...
            replyEffect= effectBuilder.thenReply(replyTo, (state) -> new MultiTenantCreditScoreSM.AcknowledgeResponse());
        }
