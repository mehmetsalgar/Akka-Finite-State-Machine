...
public abstract class ADRRESCHECK_RESULT_RECEIVED_$$_FRAUDPREVENTION_ADRESSCHECK_RESULT_RECEIVED_addressCheckResultReceived_fraudPreventionResultReceived_Action
    ...
    public ReplyEffect<CreditSM.PersistEvent, CreditSM.State> doAction(
        ...
        actorContext.log().debug("Executing ADRRESCHECK_RESULT_RECEIVED addressCheckResultReceived_fraudPreventionResultReceived Action");
    ...
    protected ReplyEffect<CreditSM.PersistEvent, CreditSM.State> processPersist(
        ...
        EffectBuilder<CreditSM.PersistEvent, CreditSM.State> effectBuilder =
                        Effect
                        .persist(new CreditSM.AdressCheckFraudPreventionReceviedPersistEvent(controlObject));
