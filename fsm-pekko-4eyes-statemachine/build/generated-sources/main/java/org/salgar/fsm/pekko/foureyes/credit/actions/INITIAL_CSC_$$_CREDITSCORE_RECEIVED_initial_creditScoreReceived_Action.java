...
public abstract class INITIAL_CSC_$$_CREDITSCORE_RECEIVED_initial_creditScoreReceived_Action
    ...
    public ReplyEffect<CreditSM.PersistEvent, CreditSM.State> doAction(
        ...
        actorContext.log().debug("Executing INITIAL_CSC initial_creditScoreReceived Action");
    ...
    protected ReplyEffect<CreditSM.PersistEvent, CreditSM.State> processPersist(
        ...
        EffectBuilder<CreditSM.PersistEvent, CreditSM.State> effectBuilder =
                        Effect
                        .persist(new CreditSM.CreditScoreReceivedPersistEvent(controlObject));
