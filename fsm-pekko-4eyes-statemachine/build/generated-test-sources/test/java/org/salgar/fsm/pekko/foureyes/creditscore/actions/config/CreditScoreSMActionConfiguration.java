...
public class CreditScoreSMActionConfiguration {
    ...
    @Bean
    public WAITING_RESULT_$$_RESULTRECEIVED_waitingResult_onResultReceived_Action creditscoresm_waiting_result_ResultReceived_waitingResult_onResultReceivedAction() {
        return new WAITING_RESULT_$$_RESULTRECEIVED_waitingResult_onResultReceived_ActionImpl();
    }
}
