...
@Configuration
@Profile("test")
public class MultiTenantCreditScoreSMGuardConfiguration {
    @Bean
    public WAITING_MULTI_TENANT_RESULTS_$$_FINALSTATE_isAllCreditScoreMultitenantResponded_Guard multitenantcreditscoresm_waiting_multi_tenant_results_FinalState_waitingMultiTenantResult_finalStateGuard() {
        return new WAITING_MULTI_TENANT_RESULTS_$$_FINALSTATE_isAllCreditScoreMultitenantResponded_GuardImpl();
    }
    @Bean
    public WAITING_MULTI_TENANT_RESULTS_$$_WAITING_MULTI_TENANT_RESULTS_isNotAllTenantsResponded_Guard multitenantcreditscoresm_waiting_multi_tenant_results_WAITING_MULTI_TENANT_RESULTS_waitingMultiTenantResults_waitingMultiTenantResultsGuard() {
