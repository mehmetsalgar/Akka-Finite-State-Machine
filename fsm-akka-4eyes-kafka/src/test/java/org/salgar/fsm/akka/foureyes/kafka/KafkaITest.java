package org.salgar.fsm.akka.foureyes.kafka;
...
import org.salgar.fsm.akka.converter.service.ConverterService;
import org.salgar.fsm.akka.foureyes.TestApplication;
import org.salgar.fsm.akka.foureyes.addresscheck.actions.config.AdressCheckSMActionConfiguration;
import org.salgar.fsm.akka.foureyes.addresscheck.command.AdressCheckSMCommandConstants;
import org.salgar.fsm.akka.foureyes.addresscheck.guards.config.AdressCheckSMGuardConfiguration;
import org.salgar.fsm.akka.foureyes.addresscheck.protobuf.AddressCheckResult;
...
import org.salgar.fsm.akka.foureyes.credit.command.CreditSMCommandConstants;
...
import org.salgar.fsm.akka.foureyes.creditscore.protobuf.CreditScoreResult;
...
import org.salgar.fsm.akka.foureyes.fraudprevention.command.FraudPreventionSMCommandConstants;
import org.salgar.fsm.akka.foureyes.fraudprevention.guards.config.FraudPreventionSMGuardConfiguration;
import org.salgar.fsm.akka.foureyes.fraudprevention.protobuf.FraudPreventionResult;
...
public class KafkaITest {
    ...
    public void initialTest() {
        ...
        assertEquals(
                ((List<org.salgar.fsm.akka.foureyes.credit.model.Customer>)report.state().controlObject().get(PayloadVariableConstants.CREDIT_TENANTS)).get(1),
