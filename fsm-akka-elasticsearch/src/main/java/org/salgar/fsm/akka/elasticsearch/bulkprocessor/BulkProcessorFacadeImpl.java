...
import org.salgar.fsm.akka.elasticsearch.OffsetState;
import org.salgar.fsm.akka.elasticsearch.OffsetStateImpl;
import org.salgar.fsm.akka.elasticsearch.config.BehaviorOnMalformedDoc;
import org.salgar.fsm.akka.elasticsearch.config.ElasticsearchProperties;
...
public class BulkProcessorFacadeImpl implements BulkProcessorFacade {
    ...
    private void preparebulkProcessor() {
        this.bulkProcessor = BulkProcessor
                .builder(buildConsumer(), buildListener(), "fsm-akka-bulkprocessor")
