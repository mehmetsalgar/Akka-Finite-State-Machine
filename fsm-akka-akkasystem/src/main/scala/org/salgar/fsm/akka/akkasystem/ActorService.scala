...
import akka.serialization.jackson.{JacksonObjectMapperFactory, JacksonObjectMapperProviderSetup}
import akka.util.Timeout
import com.fasterxml.jackson.core.JsonFactory
import com.fasterxml.jackson.databind.ObjectMapper
import com.fasterxml.jackson.databind.jsontype.BasicPolymorphicTypeValidator
import org.salgar.fsm.akka.akkasystem.ActorService.{customJacksonObjectMapperFactory, log, mainBehavior}
import org.salgar.fsm.akka.akkasystem.config.AkkaApplicationProperty
