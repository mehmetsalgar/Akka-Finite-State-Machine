...
import org.salgar.akka.fsm.xtend.uml.templates.facade.StateMachineFacadeTemplate
import org.salgar.akka.fsm.xtend.uml.templates.facade.SlaveStateMachineFacadeTemplate
...
class StateMachineTemplate extends AbstractGenerator {
    ...
    def generate (org.eclipse.uml2.uml.StateMachine it, IGeneratorContext context) '''
        ...
        import org.salgar.akka.fsm.base.CborSerializable
        import org.salgar.akka.fsm.base.actors.BaseActor
