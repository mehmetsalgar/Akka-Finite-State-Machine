...
import org.salgar.akka.fsm.xtend.uml.generator.FsmAkkaGlobalVariableProvider;
    ...
    private Module getDynamicModule() {
        return new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(IGlobalVariablesProvider.class).toInstance(new FsmAkkaGlobalVariableProvider());
            }
        };
    }
